...
namespace ProfileBook.ViewModels
{
    ...
    {
        public MainPageViewModel(INavigationService navigationService, IRepositoryService repositoryService, ISettingsManager settingsManager) : base(navigationService)
        {
            Title = "Users SignIn";
